...
import type { MessageData, UserData, ChatData, GroupData } from "./types";
...
export const onChatMessageCreated = onDocumentCreated(
  ...
  async (event) => {
    ...
    try {
      ...
      // Process message with AI orchestrator (non-blocking)
      processMessageWithOrchestrator({
        messageData,
        messageId,
        chatId,
        collectionType: "chats",
      }).catch((err) => logger.error("Orchestrator error:", err));
    } catch (error) {
